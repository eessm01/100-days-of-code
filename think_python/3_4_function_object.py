""" This programs is a solution for:
    Exercise 3.4. A function object is a value you can assign to a variable or pass as an 
    ...
    and calls the function four times, passing the value as a parameter. There should be only 
    two statements in the body of this function, not four.
"""

def do_for(f, argument):
    do_twice(f,argument)
    do_twice(f,argument)
